    ...
    <footer className="bg-white border-t border-brand-gray200">
      <Container>
        <div className="grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {/* SITEMAP */}
          <div>
            <p className="section-title text-sm">Navigazione</p>
            <ul className="mt-3 space-y-2 text-sm text-black/70">
              ...
              <li>
                <Link href="/courses" className="hover:text-brand-red transition-colors">
                  Corsi
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="hover:text-brand-red transition-colors">
                  Abbonamenti
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-black/70">
              ...
              <li>
                <a href={`tel:${SITE.phone.replace(/\s/g, '')}`} className="hover:text-brand-red transition-colors">
                  {SITE.phone}
                </a>
              </li>
              <li>{SITE.address}</li>
            ...
            <p className="section-title text-sm mt-6">Orari</p>
            <ul className="mt-3 space-y-2 text-sm text-black/70">
              {SITE.hours.map((h) => (
          ...
          {/* SOCIAL */}
          <div>
            <p className="section-title text-sm">Social</p>
            ...
            <div className="mt-3 space-y-3">
              ...
              <a
                ...
                className="flex items-center gap-3 text-sm font-semibold text-black/70 hover:text-brand-red transition-colors group"
              >
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[#1877F2] text-white group-hover:bg-[#166fe5] transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* BOTTOM */}
        <div className="border-t border-brand-gray200 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-black/60">
          <p>
